...
struct LooperTwoWidget : ModuleWidget {
  LooperTwoWidget(LooperTwo *module) {
    ...
    addParam(createParamCentered<LargeWarmButton>(mm2px(Vec(12.7, 21.135)), module, LooperTwo::MODE_TOGGLE_PARAM));
    addParam(createParamCentered<WarmButton>(mm2px(Vec(18.266, 50.015)), module, LooperTwo::STOP_BUTTON_PARAM));
    addParam(createParamCentered<WarmButton>(mm2px(Vec(18.47, 65.87)), module, LooperTwo::ERASE_BUTTON_PARAM));
    addParam(createParamCentered<WarmKnob>(mm2px(Vec(43.341, 112.213)), module, LooperTwo::MIX_PARAM));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.658, 34.16)), module, LooperTwo::MODE_CV_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.658, 50.015)), module, LooperTwo::STOP_CV_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.658, 65.87)), module, LooperTwo::ERASE_CV_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(31.528, 112.213)), module, LooperTwo::MIX_CV_INPUT));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.658, 112.423)), module, LooperTwo::LEFT_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(18.758, 112.423)), module, LooperTwo::RIGHT_INPUT));

    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(57.391, 75.259)), module, LooperTwo::SEND_1_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(69.491, 75.259)), module, LooperTwo::SEND_2_OUTPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(57.391, 90.901)), module, LooperTwo::RETURN_1_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(69.491, 90.901)), module, LooperTwo::RETURN_2_INPUT));

    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(57.36, 112.24)), module, LooperTwo::LEFT_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(69.46, 112.24)), module, LooperTwo::RIGHT_OUTPUT));

    addChild(createLightCentered<MediumLight<RedLight>>(mm2px(Vec(14.981, 35.219)), module, LooperTwo::RECORD_STATUS_LIGHT));
    addChild(createLightCentered<MediumLight<GreenLight>>(mm2px(Vec(20.54, 35.219)), module, LooperTwo::PLAY_STATUS_LIGHT));
  }
